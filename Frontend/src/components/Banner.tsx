...
const Banner = () => {
    return (
        <div className="bg-black text-white text-sm sm:text-xl font-bold relative">
            <div className="max-w-[1200px] mx-auto flex items-center px-4 justify-between">
                <div className="w-1/3"></div>

                <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 whitespace-nowrap">
                    Free Delivery for Every Order above Rs-1000
                </div>
