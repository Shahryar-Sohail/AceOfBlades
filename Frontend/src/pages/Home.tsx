            ...
            >
                ...
                <div className="relative flex justify-center px-4 lg:px-0">
                    <div className="max-w-[1200px] w-full py-40 text-right pr-12">
                        ...
                        <div className="flex flex-col md:flex-row justify-end items-end gap-4 mt-4 pr-1 mr-0">
                            <button className="btn btn-soft bg-white hover:bg-gray-800 hover:text-white hover:border-none rounded-none w-40 dark:text-black">
                                SHOP NOW
                            </button>
                            <button className="btn btn-soft bg-white hover:bg-gray-800 hover:text-white hover:border-none rounded-none w-40 dark:text-black">
                                KNIFE CARE
