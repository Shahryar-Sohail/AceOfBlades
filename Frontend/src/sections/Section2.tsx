const Section2 = () => {
    return (
        ...
        <div className="bg-zinc-200 text-center py-10 dark:bg-black">
            <div className="max-w-[1200px] mx-auto dark:text-white">
                <h1 className="text-3xl font-semibold  md:text-5xl">DAMASCUS KNIVES</h1>
                <p className="text-center w-1/2 mx-auto italic text-xl">
